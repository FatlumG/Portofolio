...
function Footer() {
  return (
    <div
      id="footer"
      className="footer text-white d-flex flex-column-reverse flex-md-row justify-content-between gap-4 pt-5"
    >
      <div className="my-info">
        <h2>Get In Touch</h2>
        <p className="text-secondary">For business and partnership inquiry please contact me below!</p>
      ...
      <div className="footer-image ps-5 d-flex justify-content-center">
        <img src={footerVector} alt="Footer Vector" />
      </div>
    </div>
  );
}
